...
func TestToHTTPErrorMapsStableCodesCentrally(t *testing.T) {
	tests := []struct {
		...
		{uploadsecurity.CodeOOXMLInvalid, http.StatusUnprocessableEntity},
		{uploadsecurity.CodeOOXMLDangerousContent, http.StatusUnprocessableEntity},
		{uploadsecurity.CodeOOXMLResourceLimit, http.StatusRequestEntityTooLarge},
