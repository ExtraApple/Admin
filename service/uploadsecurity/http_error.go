...
var httpErrors = map[Code]HTTPError{
	...
	CodeOOXMLInvalid:           {http.StatusUnprocessableEntity, CodeOOXMLInvalid, "Office 文档格式无效"},
	CodeOOXMLDangerousContent:  {http.StatusUnprocessableEntity, CodeOOXMLDangerousContent, "Office 文档包含不允许的内容"},
	CodeOOXMLResourceLimit:     {http.StatusRequestEntityTooLarge, CodeOOXMLResourceLimit, "Office 文档超过资源限制"},
